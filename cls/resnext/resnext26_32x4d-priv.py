...
def get_symbol(num_classes, num_filter, num_group, model_name, **kwargs):
    ...
    output_layer = stage(1, 2, model_name, pool1, num_filter * 2, num_filter * 4, num_group)
    output_layer = stage(3, 2, model_name, output_layer, num_filter * 4, num_filter * 8, num_group)
    output_layer = stage(5, 2, model_name, output_layer, num_filter * 8, num_filter * 16, num_group)
    output_layer = stage(7, 2, model_name, output_layer, num_filter * 16, num_filter * 32, num_group)
...
softmax.save('resnext26-32x4d-priv-symbol.json')
