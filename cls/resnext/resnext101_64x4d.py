...
def get_symbol(num_classes, num_filter, num_group, model_name, **kwargs):
    ...
    output_layer = stage(1, 3, model_name, pool1, num_filter * 4, num_filter * 4, num_group)
    output_layer = stage(4, 4, model_name, output_layer, num_filter * 8, num_filter * 8, num_group)
    output_layer = stage(8, 23, model_name, output_layer, num_filter * 16, num_filter * 16, num_group)
    output_layer = stage(31, 3, model_name, output_layer, num_filter * 32, num_filter * 32, num_group)
...
softmax = get_symbol(1000, 64, 64, 'resx', 'use_global_stats')
softmax.save('resnext101-64x4d-symbol.json')
