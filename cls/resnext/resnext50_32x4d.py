...
def get_symbol(num_classes, num_filter, num_group, model_name, **kwargs):
    ...
    output_layer = stage(8, 6, model_name, output_layer, num_filter * 8, num_filter * 16, num_group)
    output_layer = stage(14, 3, model_name, output_layer, num_filter * 16, num_filter * 32, num_group)
...
softmax.save('resnext50-32x4d-symbol.json')
