...
def senet_block(data, name, num_filter, stride, match):
    reduce_relu = Conv(data, name + '_1x1_reduce', num_filter, (1, 1), stride, (0, 0))
    conv_3x3_relu = Conv(reduce_relu, name + '_3x3', num_filter, (3, 3), (1, 1), (1, 1))
...
def get_symbol(num_classes=1000):
    ...
    stage2 = stage(4, 8, stage1, 128, 2, 'seres')
    stage3 = stage(12, 36, stage2, 256, 2, 'seres')
    stage4 = stage(48, 3, stage3, 512, 2, 'seres')
...
softmax.save('se-resnet152-symbol.json')
